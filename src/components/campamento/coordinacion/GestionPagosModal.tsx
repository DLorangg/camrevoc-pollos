            ...
            {inscripto.pagos.length === 0 ? (
              ...
              <div className="divide-y divide-slate-100 rounded-xl border border-slate-200 bg-white">
                {inscripto.pagos.map((pago, idx) => (
                  <div key={pago.id || idx} className="p-3.5 text-xs text-slate-700 space-y-1">
                    ...
                    <div className="flex items-center justify-between pt-0.5">
                      <span className="flex items-center gap-1 text-slate-500">
                        ...
                        Registró: <strong>{pago.registrado_por}</strong>
                      </span>
                    ...
                    {pago.observaciones && (
                      <p className="text-[11px] text-slate-600 bg-slate-50 p-1.5 rounded-md italic">
